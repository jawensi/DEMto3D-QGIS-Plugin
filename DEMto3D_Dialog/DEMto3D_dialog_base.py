...
class Ui_DEMto3DDialogBase(object):
    def setupUi(self, DEMto3DDialogBase):
        ...
        DEMto3DDialogBase.resize(500, 700)
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/plugins/DEMto3D/icons/demto3d.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.horizontalLayout_5.addWidget(
            self.mMapLayerComboBox, 0, QtCore.Qt.AlignVCenter
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.borderModelLineEdit.sizePolicy().hasHeightForWidth()
        )
