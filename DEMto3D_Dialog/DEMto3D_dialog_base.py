# Form implementation generated from reading ui file 'C:\Users\jawen\AppData\Roaming\QGIS\QGIS4\profiles\default\python\plugins\DEMto3D-QGIS-Plugin\DEMto3D_Dialog\DEMto3D_dialog_base.ui'
#
...
class Ui_DEMto3DDialogBase(object):
    def setupUi(self, DEMto3DDialogBase):
        ...
        DEMto3DDialogBase.resize(436, 646)
        icon = QtGui.QIcon()
        ...
        self.scrollArea = QtWidgets.QScrollArea(parent=DEMto3DDialogBase)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 402, 681))
        ...
        self.label_19 = QtWidgets.QLabel(parent=self.groupBox_1)
        ...
        self.horizontalLayout_5.addWidget(self.mMapLayerComboBox, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.verticalLayout_3.addLayout(self.horizontalLayout_5)
        self.LimitsAbsGframe = QtWidgets.QFrame(parent=self.groupBox_1)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.LimitsAbsGframe)
        self.label_5.setObjectName("label_5")
        self._3.addWidget(self.label_5, 1, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=self.LimitsAbsGframe)
        self.label_3.setObjectName("label_3")
        self._3.addWidget(self.label_3, 0, 3, 1, 1)
        self.XMinLineEdit = QtWidgets.QLineEdit(parent=self.LimitsAbsGframe)
        self.XMinLineEdit.setObjectName("XMinLineEdit")
        self._3.addWidget(self.XMinLineEdit, 1, 2, 1, 1)
        self.YMinLineEdit = QtWidgets.QLineEdit(parent=self.LimitsAbsGframe)
        self.YMinLineEdit.setObjectName("YMinLineEdit")
        self._3.addWidget(self.YMinLineEdit, 1, 4, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=self.LimitsAbsGframe)
        ...
        self.LimitsParamGframe = QtWidgets.QWidget(parent=self.groupBox_1)
        ...
        self.label_20 = QtWidgets.QLabel(parent=self.LimitsParamGframe)
        self.label_20.setObjectName("label_20")
        self.horizontalLayout_2.addWidget(self.label_20)
        self.WidthGeoLineEdit = QtWidgets.QLineEdit(parent=self.LimitsParamGframe)
        self.WidthGeoLineEdit.setObjectName("WidthGeoLineEdit")
        self.horizontalLayout_2.addWidget(self.WidthGeoLineEdit)
        self.label_22 = QtWidgets.QLabel(parent=self.LimitsParamGframe)
        self.label_22.setObjectName("label_22")
        self.horizontalLayout_2.addWidget(self.label_22)
        self.HeightGeoLineEdit = QtWidgets.QLineEdit(parent=self.LimitsParamGframe)
        ...
        self.ScaleLineEdit = QgsScaleWidget(parent=self.groupBox_3)
        self.ScaleLineEdit.setObjectName("ScaleLineEdit")
        self.gridLayout_3.addWidget(self.ScaleLineEdit, 3, 1, 1, 1)
        self.ZScaleDoubleSpinBox = QtWidgets.QDoubleSpinBox(parent=self.groupBox_3)
        ...
        self.SpacingLineEdit = QtWidgets.QLineEdit(parent=self.groupBox_3)
        ...
        self.RevereseZCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_3)
        ...
        self.RowPartsSpinBox = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.ColPartsSpinBox = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.BaseModellineEdit = QtWidgets.QLineEdit(parent=self.groupBox_5)
        ...
        self.BaseHeightLineEdit = QtWidgets.QLineEdit(parent=self.groupBox_5)
        self.BaseHeightLineEdit.setObjectName("BaseHeightLineEdit")
        self.gridLayout_2.addWidget(self.BaseHeightLineEdit, 0, 1, 1, 1)
        self.HeightModelLabel = QtWidgets.QLabel(parent=self.groupBox_5)
        ...
        self.borderModelLineEdit = QtWidgets.QLineEdit(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.SidesCheckBox = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.ProgressLabel = QtWidgets.QLabel(parent=DEMto3DDialogBase)
        self.ProgressLabel.setObjectName("ProgressLabel")
        self.progressLayoutV.addWidget(self.ProgressLabel)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.progressBar = QtWidgets.QProgressBar(parent=DEMto3DDialogBase)
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.horizontalLayout_3.addWidget(self.progressBar)
        self.cancelProgressToolButton = QtWidgets.QToolButton(parent=DEMto3DDialogBase)
        ...
        self.ParamPushButton = QtWidgets.QPushButton(parent=DEMto3DDialogBase)
        ...
        self.CancelToolButton = QtWidgets.QToolButton(parent=DEMto3DDialogBase)
    ...
    def retranslateUi(self, DEMto3DDialogBase):
        ...
        self.label_17.setText(_translate("DEMto3DDialogBase", "Height (mm):"))
