...
class Ui_DEMto3DDialogBase(object):
    def setupUi(self, DEMto3DDialogBase):
        ...
        DEMto3DDialogBase.resize(410, 520)
        DEMto3DDialogBase.setMinimumSize(QtCore.QSize(410, 0))
        DEMto3DDialogBase.setMaximumSize(QtCore.QSize(410, 520))
        icon = QtGui.QIcon()
        ...
        self.horizontalLayout_2.addWidget(self.cancelProgressToolButton)
        ...
        DEMto3DDialogBase.setTabOrder(self.CancelToolButton, self.cancelProgressToolButton)
    ...
    def retranslateUi(self, DEMto3DDialogBase):
        ...
        self.label_16.setText(_translate("DEMto3DDialogBase", "Exaggeration terrain factor:"))
